    ...
    try {
      const res = await fetch(`${BASE_URL}/auth/register`, {
        ...
        body: JSON.stringify({
          ...
          role,
          avatar,
          publisherCode: role === "publisher" ? publisherCode : null
        })
      });
  ...
  style={{
    backgroundImage: "url('https://images.unsplash.com/photo-1498050108023-c5249f4df085')"
      ...
      <div className="w-full max-w-md bg-black text-white p-6 md:p-8 rounded-xl shadow-md">
        ...
        <h2 className="text-xl text-white md:text-2xl font-bold mb-4 text-center">
          REGISTER
        </h2>
        ...
        <p className="text-center mt-4 text-sm md:text-base">
          ...
          <Link to="/login" className="text-red-200 cursor-pointer">
            Login
          </Link>
        </p>
